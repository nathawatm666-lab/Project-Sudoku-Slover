...
เพื่อให้คุณสนุกกับเกม Sudoku ได้อย่างลื่นไหล สามารถใช้งานผ่านเมาส์และคีย์บอร์ดได้ดังนี้:

* **เลือกช่อง (Select Cell):** คลิกที่ช่องที่ต้องการด้วยเมาส์ หรือใช้ปุ่มลูกศร **↑ ↓ ← →** บนคีย์บอร์ดเพื่อเลื่อนตำแหน่งได้อย่างรวดเร็ว
* **กรอกตัวเลข (Input Number):** พิมพ์ตัวเลข **1-9** บนคีย์บอร์ดเพื่อเติมลงในช่องที่เลือกไว้
* **ลบตัวเลข (Delete/Clear Cell):** หากต้องการแก้ไข ให้กดปุ่ม **Backspace** หรือ **Delete** เพื่อลบตัวเลขออกจากช่องนั้น
* **ดูเฉลย (Reveal Solution):** กดปุ่ม **👁 Solve** เพื่อให้ระบบใช้ Backtracking Algorithm คำนวณและแสดงคำตอบทั้งหมดพร้อมแอนิเมชัน
* **เริ่มเกมใหม่ (Reset Board):** กดปุ่ม **🗑 Clear All** เพื่อล้างตัวเลขทั้งหมดบนกระดานและเริ่มต้นกรอกโจทย์ใหม่
